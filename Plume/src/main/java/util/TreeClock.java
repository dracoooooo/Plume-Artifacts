...
public class TreeClock implements Clock<TreeClock> {
    ...
    @Override
    public boolean isEqual(TreeClock clock) {
        return this.isLessThanOrEqual(clock) && clock.isLessThanOrEqual(this);
    }
